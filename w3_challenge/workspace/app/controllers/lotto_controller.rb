...
class LottoController < ApplicationController
  ...
  def pick_and_check
    ...
    @mssg=""
    if (drw_numbers-my_nums).count == 0
      @mssg= "1등입니다"
    elsif (drw_numbers-my_nums).count == 1
      if (my_nums-bonus_number).count == 5
      @mssg= "2등입니다"
      end
    elsif (drw_numbers-my_nums).count == 2
      @mssg= "3등입니다"
    elsif (drw_numbers-my_nums).count == 3
      @mssg= "4등입니다"
    elsif (drw_numbers-my_nums).count == 4
      @mssg= "5등입니다"
    else 
      @mssg= "6등입니다"
    end
